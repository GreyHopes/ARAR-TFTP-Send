...
public class Client
{
    ...
    public static void sendFile(String nomFichier)
    {
        ...
        if(f.exists()) {
	        ...
	        try
	        {
	            ...
	            //On v√©rifie si on a bien re√ßu un ACK
	            if(receivedAck[0] == 0 && receivedAck[1] == 4)
	            {
	                ...
	                if(fichier != null)
	                {
	                    System.out.println("Fichier envoyÈ avec succËs !");
	                    fichier.close();
	                }
        	...
        	System.out.println("Fichier introuvable ! Veuillez relancer le programme");
        }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Entrez le nom du fichier ‡ envoyer :");
